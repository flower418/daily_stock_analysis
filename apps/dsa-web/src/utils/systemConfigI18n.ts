...
const fieldTitleMap: Record<string, string> = {
  ...
  GITHUB_ACTIONS_REPO: 'GitHub Actions 仓库',
  GITHUB_ACTIONS_TOKEN: 'GitHub Actions Token',
  GITHUB_ACTIONS_WORKFLOW: 'GitHub Actions Workflow',
  GITHUB_ACTIONS_BRANCH: 'GitHub Actions 分支',
...
const fieldDescriptionMap: Record<string, string> = {
  ...
  GITHUB_ACTIONS_REPO: '桌面端连接的 GitHub 仓库，格式 owner/repo，例如 flower418/daily_stock_analysis。',
  GITHUB_ACTIONS_TOKEN: 'Fine-grained GitHub token，仅由本地后端用于读取 Actions 运行和触发 workflow，不会返回给前端。',
  GITHUB_ACTIONS_WORKFLOW: '要查看和触发的 workflow 文件名或 ID，默认 00-daily-analysis.yml。',
  GITHUB_ACTIONS_BRANCH: '触发 workflow_dispatch 时使用的分支，通常为 main。',
