...
import { BarChart3, Bell, BriefcaseBusiness, Cloud, Home, LogOut, MessageSquareQuote, Search, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'cloud-actions', label: '云端任务', to: '/cloud-actions', icon: Cloud },
...
export const SidebarNav: React.FC<SidebarNavProps> = ({ collapsed = false, onNavigate, variant = 'default' }) => {
  ...
  const itemActiveClass = 'border-[var(--nav-active-border)] bg-[var(--nav-active-bg)] text-[hsl(var(--primary))]';
