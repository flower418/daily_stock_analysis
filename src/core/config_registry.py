...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "GITHUB_ACTIONS_REPO": {
        ...
        "description": "Repository used by the local Desktop/Web UI to inspect and trigger cloud daily analysis workflows.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "default_value": "",
        "options": [],
        "validation": {"pattern": r"^[A-Za-z0-9_.-]+/[A-Za-z0-9_.-]+$"},
        "display_order": 13,
        "help_key": "settings.system.github_actions",
        "examples": [
            "GITHUB_ACTIONS_REPO=flower418/daily_stock_analysis",
        ],
        "docs": [
            {
                "label": "完整指南：GitHub Actions 定时",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#github-actions-定时",
            },
        ],
        "warning_codes": ["desktop_local_only"],
    },
    "GITHUB_ACTIONS_TOKEN": {
        "title": "GitHub Actions Token",
        "description": "Fine-grained GitHub token used only by the local backend to read and dispatch workflow runs.",
        "category": "system",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
        ...
        "warning_codes": ["secret_local_storage"],
    },
    "GITHUB_ACTIONS_WORKFLOW": {
        "title": "GitHub Actions Workflow",
        "description": "Workflow file name or ID to inspect and dispatch.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "00-daily-analysis.yml",
        "options": [],
        "validation": {},
        "display_order": 15,
        "help_key": "settings.system.github_actions",
    ...
    "GITHUB_ACTIONS_BRANCH": {
        ...
        "description": "Branch/ref used when dispatching the workflow.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
